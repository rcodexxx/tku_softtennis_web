...
class PlayerBasicSchema(Schema):
...
class MatchRecordResponseSchema(Schema):
    ...
    player1 = fields.Nested(PlayerBasicSchema, dump_only=True, allow_none=True)
    player2 = fields.Nested(PlayerBasicSchema, dump_only=True, allow_none=True)
    player3 = fields.Nested(PlayerBasicSchema, dump_only=True, allow_none=True)
    player4 = fields.Nested(PlayerBasicSchema, dump_only=True, allow_none=True)
