<template>
  <div class="management-center-page">
    ...
    <n-tabs v-model:value="currentView" type="line" animated justify-content="center" class="management-tabs">
    ...
    <div class="management-content-area">
      ...
      <OrganizationManagement v-if="currentView === 'organizations'" :search-term-prop="searchTerm" />
    </div>
  </div>
</template>
